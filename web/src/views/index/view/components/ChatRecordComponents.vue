<template>
  ...
  <!-- 聊天话题-->
  <el-drawer size="320px" v-model="chatVisible" direction="ltr" style="background-color: #2D2B31;"
  >
  ...
  <el-dialog
      ...
      title="偏好设置"
      width="600px"
      style="background-color: #282828;border-radius: 8px;height: 360px"
  >
    <div class="setting-container">
      <div>
        ...
        <div class="setting-row">
          ...
          <div>
            <el-select v-model="drawingIndex" class="m-2" size="large" @change="onChangeDrawing">
              <el-option
  ...
  <!-- 微应用-->
  <el-drawer size="320px" v-model="appVisible" direction="ltr" style="background-color: #2D2B31;"
  >
...
onMounted(() => {
  if (store.getters.userInfo) {
    ...
    drawingList.value = data.drawingList
    drawingIndex.value = data.drawingIndex
